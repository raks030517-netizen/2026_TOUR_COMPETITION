...
public class GlobalExceptionHandler {
    ...
    public Map<String, String> handleLlmAnalysisFailedException() {
        return Map.of(
                "message",
                "요청을 분석하지 못했습니다. 잠시 후 다시 시도해 주세요."
        );
    }
